...
export const CRYSTAL_OFFERS: CrystalOffer[] = [
	...
	{ productId: DevProduct.CRYSTALS_15, robuxPrice: 100, crystals: 15, bonusCrystals: 2 },
	{ productId: DevProduct.CRYSTALS_25, robuxPrice: 200, crystals: 25, bonusCrystals: 3 },
];

export const MONEY_OFFERS: MoneyOffer[] = [
	{ productId: DevProduct.MONEY_100, robuxPrice: 10, cash: 100, bonusCash: 10 },
	{ productId: DevProduct.MONEY_500, robuxPrice: 50, cash: 500, bonusCash: 50 },
	{ productId: DevProduct.MONEY_2500, robuxPrice: 200, cash: 2500, bonusCash: 250 },
	{ productId: DevProduct.MONEY_10000, robuxPrice: 500, cash: 10000, bonusCash: 1000 },
